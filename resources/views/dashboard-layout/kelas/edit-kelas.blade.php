...
<div class="container">
    ...
    <div class="py-3 mt-1 bg-white">
        <h4 class="fw-bold text-secondary text-uppercase">Ubah kelas</h4>
        <br>
        <form action="/dashboard/kelas/{{$kelas->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-10">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" type="text" cols="30" rows="10" class="form-control">{{old("deskripsi",$kelas->deskripsi)}}</textarea>
                </div>
                @error("deskripsi")
                <div>
                    <small class="text-danger">{{$message}}</small>
