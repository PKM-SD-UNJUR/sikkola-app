...
<div class="container formtambah mt-3 col-10 p-3 bg-light" style="max-width: 800px;">
    <form action="/kelas/latihan/{{$mapel->id}}" enctype="multipart/form-data" method="post" class="form-group">
        @csrf
        <div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-2">
                ...
                <input id="link" value="{{old('link')}}" name="link" class="form-control form-sm @error('link')is-invalid @enderror" type="text" placeholder="Masukkan link latihan disini...">
            </div>
            <div class="col-md-6 mt-2">
                ...
                <input id="waktumulai" value="{{old('waktumulai')}}" name="waktumulai" class="form-control form-sm @error('waktumulai')is-invalid @enderror" type="datetime-local">
            </div>
            <div class="col-md-6 mt-2">
                ...
                <input id="waktuselesai" value="{{old('waktuselesai')}}" name="waktuselesai" class="form-control form-sm @error('waktuselesai')is-invalid @enderror" type="datetime-local">
            </div>
            <div class="col-md-12 mt-3 mb-2">
                ...
                <textarea class="form-control ck-editor @error('keterangan')is-invalid @enderror" name="keterangan" id="editor" cols="20" rows="30">{{ old('keterangan')}} </textarea>
            </div>
