        ...
        <div class="row">
          ...
          <div class="col-12 container mb-2">
            <div class="list-group list-group-horizontal-md" id="list-tab" role="tablist">
              ...
              <a class="list-group-item list-group-item-action @if($tg == " 07") active @endif" id="list-messages-list" href="/kelas/latihan/{{$mapel->id}}/{{$tgl = "07"}}" role="tab" aria-controls="list-messages">July</a>
