...
<div class="container formtambah mt-3 col-10 p-3 bg-light" style="max-width: 800px;">
  <form action="/kelas/materi/forum/mapel/{{$mapel->id}}/quiz/{{$quiz->id}}" enctype="multipart/form-data" method="post" class="form-group">
      @csrf
      @method('put')
      <div>
      ...
      <div class="row">
        <div class="col-md-6 mt-2">
          ...
          <div class="col-md-12 mt-3 mb-2">
              ...
              <textarea class="form-control ck-editor" name="keterangan" id="editor" cols="20" rows="30">{{ old('keterangan',$quiz->keterangan)}} </textarea>
          </div>
