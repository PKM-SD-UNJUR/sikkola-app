...
<div class="container">
    <div class="py-2 mb-2">
        <a class="fw-bold" href="/kelas/materi/forum/mapel/{{$mapel->id}}/quiz"><i class="fas fa-angle-double-left"></i> KEMBALI KE LIST QUIZ</a>
    </div>
    <br>
    <div class="container bg-white main-page p-5">
        ...
        <div class="ms-auto">
            <a class="fw-bold text-secondary" href="/kelas/materi/forum/mapel/{{$mapel->id}}/quiz/{{$quiz->id}}/edit"><i class="far fa-edit"></i> EDIT</a>&nbsp; | &nbsp;
            <a class="fw-bold text-secondary" data-bs-toggle="modal" data-bs-target="#delete{{$quiz->id}}"><i class="far fa-trash-alt"></i> HAPUS</a>
        </div><br>
        @endif
       <div class="d-flex">
       ...
       <br>
        ...
        <div class="text-center mt-5">
          ...
          @endif
          @if ( $myresult->nilai < 60)
          <img class="score-img" src="{{asset('icon/keep.gif')}}" alt="">
    ...
    <div class="container bg-white main-page p-5">
      <div class="d-flex justify-content-start">
        ...
        @if (!$quiz->status)
          ...
          <a class="btn btn-dark btn-sm fw-bold text-white text-uppercase" href="/kelas/materi/forum/quiz/{{$quiz->id}}}/soal/create"> + tambah soal</a>
        @else
        ...
        <tr class="w-100">
          ...
          <td>
            <div class="py-3 manage-soal">
              <a class="text-secondary fw-bold" href="/kelas/materi/forum/quiz/{{$quiz->id}}/soal/{{$s->id}}/edit"><small>&#128394; UBAH</small></a>&nbsp;&nbsp;
              <a class="text-secondary fw-bold" data-bs-toggle="modal" data-bs-target="#soal{{$s->id}}"><small>&#128465; HAPUS</small></a>
            </div>
          </td>
          @endif
        </tr>
